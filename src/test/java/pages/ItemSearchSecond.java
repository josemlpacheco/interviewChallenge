...
public class ItemSearchSecond extends Base {
	
	@FindBy(id = "twotabsearchtextbox")
	WebElement searchBox;
	
	@FindBy(xpath = "//span[.='\"Galaxy S20 FE 5G\"']")
	...
	public ItemSearchSecond(WebDriver driver) {
		super(driver);
	}
	
	public String searchItem() throws InterruptedException {
		inputText("Galaxy S20 FE 5G", searchBox);
		searchBox.submit();
		Thread.sleep(2000);
		String price="";
