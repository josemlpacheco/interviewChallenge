...
public class ItemSearchWithExternalDataSecond extends Base {
	
	@FindBy(id = "twotabsearchtextbox")
	WebElement searchBox;
	
	@FindBy(xpath = "//span[.='\"iphone 11 pro max\"']")
	...
	public ItemSearchWithExternalDataSecond(WebDriver driver) {
		super(driver);
	}
	...
	public String searchItem() throws InterruptedException, IOException {
		...
		inputText((sheet.getRow(1).getCell(0).getStringCellValue()), searchBox);
		searchBox.submit();
		Thread.sleep(2000);
		String price="";
